...
class Agent:
    ...
    def __init__(self, agent_id:int, action_size:int, obs_size:int, num_agents:int,device:str="cpu",lr=0.01):
        ...
        self.q_grad = torch.optim.Adam(self.q_function.model.parameters(),0.01,weight_decay=0.5)

        self.policy = DPN(obs_size,action_size,device)
        self.policy.apply(init_weights)
        self.policy_target = deepcopy(self.policy)
        self.policy_grad = torch.optim.Adam(self.policy.model.parameters(),0.001,weight_decay=0.5)
...
class ConstrainedAgent:
    ...
    def __init__(self, agent_id:int, action_size:int, obs_size:int, num_agents:int,device:str="cpu",lr=0.01):
        ...
        self.q_grad_r = torch.optim.Adam(self.q_function_r.model.parameters(),0.01,weight_decay=0.5)
        ...
        self.q_grad_c = torch.optim.Adam(self.q_function_c.model.parameters(), 0.01,weight_decay=0.5)

        self.policy = DPN(obs_size,action_size,device)
        self.policy.apply(init_weights)
        self.policy_target = deepcopy(self.policy)
        self.policy_grad = torch.optim.Adam(self.policy.model.parameters(),lr=0.001,weight_decay=0.5)
