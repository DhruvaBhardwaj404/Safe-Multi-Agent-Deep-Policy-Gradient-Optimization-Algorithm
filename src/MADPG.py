...
class MADPG:
    """
    Implements Multi-Agent Deep Policy Gradient Algorithm
    """
    def __init__(self,obs_size:int,action_size:int,agent_num:int,gamma:float,
        ...
        # try:
        #     self.training_logs = pd.read_csv("./training_record_MADPG.csv")
        #     self.performance_logs = pd.read_csv("./performance_record_MADPG.csv")
    ...
    #     self.training_logs.to_csv("./training_record_MADPG.csv")
    #     self.performance_logs.to_csv("./performance_record_MADPG.csv")